...
class Base:
    ...
    It represents the "base" for all other classes in all the project.
    ...
    def __init__(self, id=None):
        ...
        Args:
            id (int): It's the identity of the new Base.
        """
        if id is not None:
            self.id = id
        else:
    ...
    def from_json_string(json_string):
        """This returns deserialization of a JSON string.
    ...
    def draw(list_rectangles, list_squares):
        """Method draws Rectangles and Squares using the turtle module.
