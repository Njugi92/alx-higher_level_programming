...
class Rectangle(Base):
    ...
    @property
    def height(self):
        """This sets/gets height of the Rectangle."""
    ...
    @property
    def x(self):
        """It sets/gets x coordinate of the Rectangle."""
        return self.__x
    ...
    @property
    def y(self):
        """It sets/gets y coordinate of the Rectangle."""
        return self.__y
    ...
    def area(self):
        """To return area of the Rectangle."""
        return (self.width * self.height)

    def display(self):
        """Method prints Rectangle using the `#` char."""
    ...
    def __str__(self):
        """This returns print() and str() representations of the Rectangle."""
